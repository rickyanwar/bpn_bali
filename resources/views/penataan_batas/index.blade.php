                        ...
                        <div class="row d-flex align-items-center ">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box mt-3">
                                    <a href="{{ route('penataan_batas.create') }}"
                                        data-url="{{ route('penataan_batas.create') }}"
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="{{ route('penataan_batas.index') }}" class="btn btn-sm btn-danger"
...
@push('script-page')
    <script type="text/javascript">
        var table = $('#data-table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('penataan_batas.index') }}",
                data: {
                    issue_date: function() {
