...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Pemecahan') }}</li>
@endsection
        ...
        <div class="col-3">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <h5 style="font-weight: 100">Total Pemecahan</h5>
                </div>
            </div>
        </div>
        <div class="col-3">
                        ...
                        <div class="row d-flex align-items-center ">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box mt-3">
                                    <a href="{{ route('pemecahan.create') }}" data-url="{{ route('pemecahan.create') }}"
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="{{ route('pemecahan.index') }}" class="btn btn-sm btn-danger" data-toggle="tooltip"
